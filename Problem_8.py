...
## This code takes the large 1000 digit number as a string input and then
## splits it into multiple strings at 0s. It then figures out how many of those
## strings are 13 or larger in length. It then calculated required product and
## compares.
